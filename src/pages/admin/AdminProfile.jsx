              ...
              <div className="row">
                ...
                <div className="col-9">
                  ...
                  <div className="container-fluid">
                    <header>
                      <h5 className="display-8 mb-4 ">August</h5>
                      <p>Tasks</p>
                      <small>
                        Amount Transfer, Add new Service, Candidate Interview
                      </small>
                      <div className="row d-none d-sm-flex p-1 border">
                    ...
                    <div className="row border border-right-0 border-bottom-0">
                      ...
                      <div className="day col-sm p-2 border border-left-0 border-top-0 text-truncate bg-dark">
                        <h5 className="row align-items-center">
                          <span className="date col-1 text-danger ">3</span>
                          <small className="col d-sm-none text-center text-muted">
                            Friday
                          </small>
                          <span className="col-1"></span>
                        ...
                        <Link
                          className="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small  text-white"
                          title="Test Event 1"
                        >
                          create Deal
                        </Link>
                      ...
                      <div className="day col-sm p-2 border border-left-0 border-top-0 text-truncate bg-dark">
                        <h5 className="row align-items-center">
                          <span className="date col-1 text-danger">8</span>
                          <small className="col d-sm-none text-center text-muted">
                            Wednesday
                          </small>
                          <span className="col-1"></span>
                      ...
                      <div className="day col-sm p-2 border border-left-0 border-top-0 text-truncate bg-dark ">
                        <h5 className="row align-items-center">
                          <span className="date col-1 text-danger">20</span>
                          <small className="col d-sm-none text-center text-muted">
                            Monday
                          </small>
                          <span className="col-1"></span>
